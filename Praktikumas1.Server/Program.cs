...
services.AddScoped<IGetProgrammeService, GetProgrammeService>();
services.AddScoped<ISaveProgrammeService, SaveProgrammeService>();
services.AddScoped<IGetLecturerService, GetLecturerService>();
services.AddScoped<ISaveLecturerService, SaveLecturerService>();
services.AddScoped<IGetGroupService, GetGroupService>();
